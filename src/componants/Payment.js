...
function Payment() {
  ...
  return (
    <div>
        ...
        >
      <div className='pt'>
        <div className='p1'><div style={{width: "160px"}}>Гүйлгээний утга : </div>{modaldata.INVOICE_DESC}</div>
        ...
        <div className='p1'><div style={{width: "160px"}}>Картны төрөл : </div>{modaldata.CARD_TYPE}</div>
        <div className='p2'><div style={{width: "160px"}}>Гүйлгээний төрөл : </div>{modaldata.PAYMENT_TYPE}</div>
